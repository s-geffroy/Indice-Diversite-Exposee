...
class TestPlafondAtteignable:
    """Le plafond de l'indice dépend du nombre de contenus servis."""

    def test_un_fil_court_ne_peut_pas_atteindre_un_indice_eleve(self):
        """Ce n'est pas une limite de mesure : c'est une limite de la grandeur."""
    ...
    def test_un_fil_vide_est_refuse(self):
        ...
        with pytest.raises(ValueError):
            attainable_index(4, catalogue_size=1)
