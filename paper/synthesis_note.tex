...
rank-blind index is therefore measured for the first time on real feeds --- $0.47$ per user-day,
$4.6$ sections equally served out of $26$ --- and the exposed index only \emph{bounded}, to
...
simulation. On the window \S\ref{sec:index} prescribes --- the user-day --- the index is $0.466$
at the median, that is $4.56$ sections equally served out of $26$, with $18.8\%$ of user-days
below $0.40$ and $71.2\%$ below $0.50$. This figure does not say whether that is little or much;
...
reader, however, adds $2.5$ points to a share of $18.8\%$, and at five days still $0.6$ point ---
